...
public class ButtonListener extends MouseAdapter
{
    ...
    /**
     * Only constructor, giving the method that should be invoked when the mouse
     * is released over the button; has the responsibility of notifying
     * controller when mouse released.
     *
     * <pre>
     ...
     *
     * @param controller
     *            the controller this listener has a responsible to
     * @param method
     *            the method to invoke when button is pushed
     * @param args
     *            the array of objects that are the parameters for the method
     *            that will be invoked by the controller
     */
    ...
    /**
     * Invokes the appropriate method when the mouse button is released.
     *
     * <pre>
